 ...
 * from the specification file <tt>/home/paradoja/NetBeansProjects/AnalizadorLexico/src/main/jflex/lexer.jflex</tt>
 */
public class Lexer {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 14: break;
          case 6: 
            { tokens.add("numero"); System.out.println("NUM");
            }
          case 15: break;
          case 7: 
            { tokens.add("id"); System.out.println("ID");
            }
          case 16: break;
          case 8: 
